...
import org.dows.rade.oss.minio.MinioOssClient;
...
public class OssService {
    ...
    public void uoload() {
        ...
        OssInfo info = minioOssClient.upLoad(new File(System.getProperty("user.dir") + File.separator + "1.png"), "2.png", true);
    ...
    public void download() throws FileNotFoundException {
        ...
        minioOssClient.downLoadCheckPoint(System.getProperty("user.dir")  + File.separator + "3.png", "2.png");
    }
