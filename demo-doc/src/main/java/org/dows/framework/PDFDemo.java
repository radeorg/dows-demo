...
public class PDFDemo {
    ...
    @SneakyThrows
    public static void testExportPDF() {
        // 模板
        ...
        // 输出位置自定义
        FileOutputStream fout = new FileOutputStream("D:\\" + System.currentTimeMillis() + ".pdf");
        // 数据准备
        ...
        documentHandler.write(fin, fout, DocumentTypeEnum.PDF, thesis, null);
